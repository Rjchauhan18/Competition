...
def app():
    ...
    def plot_raw_data():
        fig = go.Figure()
        fig.add_trace(go.Scatter( x=data['State/UTs'], y=data['Discharge Ratio'], name="States"))
        fig.add_trace(go.Scatter(x=data['State/UTs'], y=data['Discharge Ratio'], name="Discharge Ratio"))
        fig.layout.update(
